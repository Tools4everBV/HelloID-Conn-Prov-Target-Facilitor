...
try {
    ...
    if ($null -ne $correlatedAccount) {
        ...
        $dryRunMessage = "Enable Facilitor account: [$($actionContext.References.Account)] for person: [$($personContext.Person.DisplayName)] will be executed during enforcement"
    } else {
        $action = 'NotFound'
